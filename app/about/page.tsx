  ...
  return (
    <main>
      ...
      <section className="shell section about-story premium-story">
        ...
        <div className="story-copy"><p>An idea becomes useful when it is understood, defined, designed, built and launched. LINETECH exists to carry that journey from the first line to a working product.</p><p>Today the company focuses on digital products, commerce, brand identity and professional presence. The long-term direction expands toward automation, artificial intelligence, computer vision and owned technology products.</p></div>
      </section>
