...
const copy = {
  en: {
    ...
    lead: "This is a starting interpretation, not a final quote or fixed scope. It helps both sides enter the review step with the same context.",
    ...
    note: "Final deliverables, price and timeline are defined after the request is reviewed.",
  },
  ar: {
    kicker: "معاينة النطاق",
    title: "هكذا تفهم لاين تك طلبك حاليًا.",
    lead: "هذه قراءة أولية وليست عرض سعر أو نطاقًا نهائيًا. هدفها أن يدخل الطرفان مرحلة المراجعة بنفس السياق.",
    ...
    note: "يتم تحديد المخرجات النهائية والسعر والمدة بعد مراجعة الطلب.",
  },
} as const;
