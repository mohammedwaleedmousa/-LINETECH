...
const qaCopy: Record<string, string> = {
  ...
  "This workspace keeps your project conversation together. Messages created here are saved on this device in the current version.": "تحافظ هذه المساحة على محادثة مشروعك في مكان واحد. الرسائل التي تنشئها هنا تُحفظ على هذا الجهاز في النسخة الحالية.",
  ...
  "Device conversation": "محادثة هذا الجهاز",
  "Messages stay on this device": "تبقى الرسائل على هذا الجهاز",
  "Project conversation": "محادثة المشروع",
  "DEVICE MODE": "وضع الجهاز",
  "Messages, photos, documents and voice notes in this conversation are saved on this device.": "يتم حفظ الرسائل والصور والمستندات والرسائل الصوتية في هذه المحادثة على هذا الجهاز.",
  "This conversation is stored on this device.": "هذه المحادثة محفوظة على هذا الجهاز.",
