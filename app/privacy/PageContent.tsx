...
export default function PrivacyPage(){return <Localized><main className="info-page page-privacy">
  ...
  <section className="info-content"><div className="ref-shell info-content-grid"><aside className="info-content-aside"><p className="ref-kicker">LAST UPDATED</p><h2>September 2026</h2><p>The current project brief is designed to keep your typed content in the browser until you choose to copy or share it.</p></aside><div className="info-prose">
    ...
    <section><h2>3. Information you send directly</h2><p>If you choose to send project information to LINETECH through a communication channel, that information may be used to understand your request, respond to you, prepare a project scope and manage the working relationship.</p></section>
    <section><h2>4. Sharing and selling</h2><p>LINETECH does not intend to sell personal information. Information may only be processed by service providers where needed to operate the website, communications or project delivery, subject to the tools and services actually used.</p></section>
    <section><h2>5. Retention</h2><p>Information that you send directly may be retained for as long as reasonably needed for communication, project records, legal obligations or legitimate business administration. Browser-only project brief content is controlled by your browser unless you choose to share it.</p></section>
    <section><h2>6. Changes to this page</h2><p>This privacy information may be updated as the website gains new features, integrations or communication methods. Material changes should be reflected on this page.</p></section>
  </div></div></section>
</main></Localized>}
