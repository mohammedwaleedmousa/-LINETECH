...
const searchItems = [
  ...
  { title: "Web Development", meta: "Service", href: "/start?service=Web%20Development", keywords: "website web development landing business custom apps" },
  { title: "E-commerce & Systems", meta: "Service", href: "/start?service=E-commerce%20%26%20Systems", keywords: "ecommerce commerce systems dashboard booking" },
  { title: "Brand Identity", meta: "Service", href: "/start?service=Brand%20Identity", keywords: "brand branding logo visual identity guidelines" },
  { title: "CV & Portfolio", meta: "Service", href: "/start?service=CV%20%26%20Portfolio", keywords: "cv portfolio career personal presence" },
