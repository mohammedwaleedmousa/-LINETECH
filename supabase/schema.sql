...
create unique index if not exists project_requests_owner_submission_key_uidx
  on public.project_requests(owner_id, submission_key)
...
begin
  ...
  where pr.owner_id = v_user_id
    and pr.submission_key = p_submission_key
  limit 1;
